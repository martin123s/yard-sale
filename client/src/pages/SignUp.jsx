      ...
      <div className="mx-24 flex flex-col min-h-screen">
        ...
        <div className="flex flex-row justify-between items-center mt-2 mb-7">
          ...
          <div className="font-sans text-lg align-middle">
            Already have an account? <a onClick={() => navigate('/signin')}
              class="underline cursor-pointer hover:text-teal-600 font-bold decoration-sky-500">Sign in</a>
          </div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="w-1/2 h-full flex flex-col bg-white shadow-xl border rounded-3xl gap-5 pb-5 border-l-red-50 border-t-gray-100">
            <div className="ml-5 mt-5 flex flex-row justify-start items-center">
              ...
              <span className="pl-5 font-mono font-bold text-2xl">Join us now !</span>
            </div>
            <div className="w-full flex justify-center mb-2">
              <img className="w-[90%] shadow-2xl border rounded-lg border-b-red-700" src={signUpPic} alt="yard sale view" />
            </div>

            <div className="ml-5 flex justify-start items-center">
              <Rss color="#3e9392" size={30} />
              <p className="text-lg">
          ...
          <div className="w-1/2 mt-[4%]">
            ...
            <div className="flex flex-col justify-center items-center h-auto pt-2">
              <div className="items-center w-[58%] ml-20">
                <a className="font-bold text-3xl">Create an account</a>
                <form onSubmit={handleSignUp} className="mt-4 max-w-md flex flex-col w-auto">

                  {/* username handle */}
                  <div className="flex flex-col mb-4 w-full">
                    <label htmlFor="username" className="mb-1 text-base">Username</label>
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        className="w-full pl-9 h-9 text-base bg-gray-50 rounded-lg border border-gray-600 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-slate-500 focus:bg-white transition-all duration-200"
                  ...
                  <div className="flex flex-row justify-start mb-2">
                    <input type="checkbox" class="checked:bg-blue-500 mr-2" />
                    <p className='text-xs'>By signing up, I agree to the
                      <a
                        onClick={() => navigate('/userterms')}
                        className="text-red-500 cursor-pointer ml-1">Terms & Conditions</a>
                    </p>
                  </div>

                  {/* submit handle */}
                  <div className="mt-6 mb-3">
                    <input type="submit" value="Sign Up" className="w-full text-white h-12 board board-gray-600 rounded-xl font-sans text-lg font-bold hover:bg-teal-700 justify-center cursor-pointer bg-teal-600"/>
                  </div>
